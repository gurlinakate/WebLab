...
class Constants {
    public static final String authorName = new String(new String("Hele"));
    ...
    private Connection connection() throws ClassNotFoundException, SQLException {
       ...
       /* //int rows2 = statement.executeUpdate("INSERT book(title, year, pages, price) VALUES ('Last_hunter', 2020, 600, 499 )," +
        ...
        public void addBook(Book book, int userId) throws SQLException, ClassNotFoundException {
            ...
            try {
                statement = connection.prepareStatement("INSERT INTO book (title, year, pages, price) VALUES (?, ?, ?, ?)");
                statement.setString(1, book.getTitle());
                statement.setInt(2, book.getYear());
                statement.setInt(3, book.getPage());
                statement.setDouble(4, book.getPrice());
                statement.executeUpdate();
                statement = connection.prepareStatement("INSERT INTO author (id , authorName) VALUES (?, ?)");
                statement.setInt(1, userId);
                statement.setString(2,Constants.authorName );
                statement.executeUpdate();
