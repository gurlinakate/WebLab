...
public class ClientClass {
    ...
    public static void main(String ...args) throws SQLException, ClassNotFoundException {
        ...
        //helper.getUsersBook(Constants.user); // вывод всех книг пользователя
        //helper.getBookByAuthorId(Constants.user.getId()); //вывод книг по заданному Id
        //helper.selectAll(); // вывод содержимого списка Book
        //helper.getUsersByBook(); //вывод пользователя по заданной книге
    }
}
