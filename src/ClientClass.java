    ...
    private Connection connection() throws ClassNotFoundException, SQLException {
       ...
       /* //int rows2 = statement.executeUpdate("INSERT book(title, year, pages, price) VALUES ('Last_hunter', 2020, 600, 499 )," +
        ...
        Statement statement = connection.createStatement();
            ...
            String rows = "INSERT customer(id, name, login, password) VALUES (?,?,?,?)";
            PreparedStatement preparedStatement = connection.prepareStatement(rows);
            preparedStatement.setInt(1, Constants.user.getId());
            preparedStatement.setString(2, Constants.user.getName());
            preparedStatement.setString(3, Constants.user.getLogin());
            preparedStatement.setString(4, Constants.user.getPassword());
        ...
        public void addAuthor(User u) throws SQLException, ClassNotFoundException {
        Scanner scanner = new Scanner(System.in);
        Connection connection = this.connection();
        Statement statement = connection.createStatement();
            ...
            preparedStatement3.setInt(1, u.getId());
...
;
        ...
        public void addBook(Author a) throws SQLException, ClassNotFoundException {
        Scanner scanner = new Scanner(System.in);
        Connection connection = this.connection();
        Statement statement = connection.createStatement();
